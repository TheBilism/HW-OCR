...
namespace OCR.OBROBKAOBRAZU
{
    public static class OBROBKA
    {
        public static Bitmap Zmniejsz(Bitmap b, int nWidth, int nHeight)
        {
        ...
        public static Bitmap Przytnij(Bitmap img)
        {
            ...
            return (Bitmap)Ciecie(img, rect);
        }

        static Image Ciecie(Image img, Rectangle cropArea)
        {
        ...
        public const double Black = 1.0;
        public const double White = -1.0;
